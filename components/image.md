...
The `ve-image` viewer supports multiple modes of operation for images.  The default mode is to render a single image with full deep-zoom and panning enabled.
